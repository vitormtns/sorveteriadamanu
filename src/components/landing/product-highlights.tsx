import { BadgePercent, Bike, IceCreamBowl, Sparkles } from "lucide-react";
import { AnimatedSection } from "./animated-section";

const items = [
  { title: "Açaí montado na hora", text: "Você escolhe o tamanho e monta do seu jeito.", icon: Sparkles },
  { title: "Sorvete de massa", text: "Sabores disponíveis no copo ou na casquinha.", icon: IceCreamBowl },
  { title: "Combos e promoções", text: "Opções do dia para aproveitar e compartilhar.", icon: BadgePercent },
  { title: "Delivery ou retirada", text: "Pedido direto para a equipe, sem enrolação.", icon: Bike },
];
