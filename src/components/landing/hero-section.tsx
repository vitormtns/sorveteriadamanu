...
export function HeroSection() {
  return (
    <section id="inicio" className="relative min-h-[92svh] overflow-hidden bg-[#24002f] text-white">
      ...
      <div className="absolute inset-0 bg-[linear-gradient(90deg,#24002f_8%,rgba(36,0,47,.9)_35%,rgba(36,0,47,.2)_72%),linear-gradient(0deg,#24002f_0%,transparent_35%)]" />
      <div className="absolute -left-32 top-32 h-96 w-96 rounded-full bg-[#ff6fae]/10 blur-3xl" />
      <div className="relative mx-auto flex min-h-[92svh] max-w-[1440px] items-center px-5 pb-16 pt-28 md:px-8">
        <div className="max-w-2xl">
          ...
          <p className="hero-enter hero-delay-2 mt-6 max-w-lg text-base leading-relaxed text-white/70 md:text-lg">Açaí montado do seu jeito, sorvetes e sobremesas preparados para retirada ou delivery.</p>
