    ...
    <section id="inicio" className="relative min-h-[92svh] overflow-hidden bg-[#24002f] text-white">
      ...
      <div className="hero-content relative mx-auto flex min-h-[92svh] max-w-[1440px] items-center px-5 pb-16 pt-28 md:px-8">
        <div className="hero-copy max-w-2xl">
          <p className="hero-enter text-xs font-bold uppercase tracking-[.18em] text-[#f8b900]">Açaí · Sorvetes · Sobremesas</p>
          <h1 className="hero-enter hero-delay mt-5 text-[clamp(3rem,7vw,7rem)] font-bold leading-[.9] tracking-[-.065em]">Monte, peça<br /><span className="text-[#ff9bc7]">e aproveite.</span></h1>
          <p className="hero-enter hero-delay-2 mt-6 max-w-lg text-base leading-relaxed text-[#e8ddf0] md:text-lg">Açaí montado do seu jeito, sorvetes e delícias geladas para retirada ou delivery.</p>
