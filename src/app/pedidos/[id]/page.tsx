...
export default function OrderDetailPage() {
  ...
  return <div className="mx-auto grid max-w-4xl gap-5">
    <div className="flex items-center justify-between gap-3"><Link href="/pedidos" className="flex items-center gap-2 font-bold text-slate-600"><ArrowLeft size={18} /> Voltar</Link><div className="flex items-center gap-2"><button type="button" disabled title="Impressão em breve" className="hidden min-h-10 items-center gap-2 rounded-xl border border-[var(--border)] px-3 text-xs font-semibold text-slate-400 sm:flex"><Printer size={15} /> Imprimir</button><StatusBadge status={order.status} /></div></div>
